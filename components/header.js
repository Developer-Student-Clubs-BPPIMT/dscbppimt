...
const Header = () => {
    return(
    <Container>
        <Grid className={styles.header} container wrap="wrap-reverse" justify="center" style={{padding : "1em"}} spacing={2}>
            <Grid item container direction="column" xs={12} md justify="center" component="div">
                ...
                <Grid item style={{marginTop : '1em'}}>
                    <Button variant="contained" color="primary" style={{marginRight : '1em'}}><Typography style={{color : 'white'}}>Become a Member</Typography></Button>
