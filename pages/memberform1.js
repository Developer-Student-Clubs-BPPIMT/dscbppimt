                    ...
                    <Box style={{margin: '10px' }}>
                        <form onSubmit={this.handleSubmit} >
                            <div style={{maxWidth: '740px', width:'90%', margin:'0 auto' }}>
                                ...
                                <TextField required id="standard-required" label="Required" style={{width : '100%'}}/>
                                <TextField required id="standard-required" label="Full Name" defaultValue="John Doe"  placeholder="Your Name" name="name" value={this.state.name} onChange={this.handleInputChange}/>       
                                </div>
