...
const TeamPage = () => {
    ...
    <Layout>
        <Grid container style={{margin : '2em 0'}} justify="center" direction="column" alignItems="center" wrap="wrap">
            <Grid item xs><MemberCard width="30em" name={lead.name} github={lead.github} linkedin={lead.linkedin} image={lead.image} pos={lead.pos}/></Grid>
            ...
            { coreLeads.map(mem => (
                <Grid item key={mem.name}><MemberCard width="23em" name={mem.name} github={mem.github} linkedin={mem.linkedin} image={mem.image} pos={mem.pos}/></Grid>
                ))}
            </Grid>
